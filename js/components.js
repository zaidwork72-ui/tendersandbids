const icons = {
  ...
  check: `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true"><circle cx="8" cy="8" r="6.25" stroke="#179462" stroke-width="1.3"/><path d="M5 8.2L7.1 10.3L11.2 6" stroke="#179462" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
